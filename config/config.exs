...
config :teller_sandbox_api, TellerSandboxApiWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: TellerSandboxApiWeb.ErrorView, accepts: ~w(html json), layout: false],
...
config :teller_sandbox_api, TellerSandboxApi.Mailer, adapter: Swoosh.Adapters.Local
